...
return array(
 ...
 IP-Intervall: Die beiden IP-Werte werden durch eine gestrichelte Linie geteilt. IP-Übereinstimmungen in diesem Intervall. <br/>",
    ...
    "admin.storage.saveCorsTips"     => "Bucket ist nicht mit CORS konfiguriert oder die Konfiguration ist falsch. Befolgen Sie zum Konfigurieren das Dokument [Hilfe verwenden]",
    ...
    "admin.backup.position"          => "Sicherungsspeicherort",
    ...
    "admin.backup.timeNote"          => "Hinweis: Es werden nur die Sicherungsdaten für die letzten 7 Tage und den 1. eines jeden Monats gespeichert. <br> Sicherungszeit:",
    "admin.backup.optionTime"        => "Die Sicherung dauert lange. Bitte versuchen Sie, einen Zeitraum außerhalb der Arbeit auszuwählen",
    "admin.backup.optionLocation"    => "Bitte erstellen Sie einen Speicher für die Sicherung",
    "admin.backup.optionTips1"       => "Die Datensicherung besteht aus zwei Teilen: Dateisicherung und Datenbanksicherung.",
    "admin.backup.optionTips2"       => "Zunächst müssen Sie einen Speicher angeben, in dem genügend Speicherplatz für den Datensicherungsspeicher reserviert ist.",
    "admin.backup.optionTips3"       => "Nach dem Start der Aufgabe werden die Dateien schrittweise im Zielspeicher gesichert, und die Datenbank ruft alle Daten ab, generiert SQL-Dateien und sichert sie nach Datum im Datenbankverzeichnis des Zielspeichers.",
    "admin.backup.optionTips4"       => "Die Sicherungsdaten speichern nur die letzten 7 Tage und den 1. eines jeden Monats.",
 ...
 post_max_size, muss neu gestartet werden)",
    ...
    "log-event-move-more-desc"       => "[1] Wechsle von [2] nach [3]",
    "log-event-moveOut-more-desc"    => "[1] entfernt aus [2] [3]",
