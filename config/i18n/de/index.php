...
return array(
    ...
    "admin.setting.loginIpCheckDesc" => "Nach dem Öffnen können sich nur Benutzer mit der angegebenen IP anmelden. Seien Sie bitte vorsichtig",
    "admin.setting.loginIpAllow"     => "Zulässige IP",
    "admin.setting.loginIpAllowDesc" => "<b>Füllen Sie die Regeln wie folgt aus (die lokale IP und die LAN-IP des Servers sind standardmäßig zulässig):</b><br/>
 Einzeilige IP: Übereinstimmung, wenn gleich, zum Beispiel: 55.55.55.55<br/>
 Einzeiliges IP-Präfix: IP beginnt mit dem Präfix und stimmt überein, zum Beispiel: 55,55<br/>
 IP-Abschnitt: Zwei IPs werden durch einen Bindestrich geteilt, und IPs stimmen in diesem Abschnitt überein, z. B. 55.55.0.0-55.55.1.255<br/>",
    ...
    "ERROR_IP_NOT_ALLOW"             => "Ihre aktuelle IP ist nicht in der Whitelist der IPs enthalten, die sich anmelden dürfen. Bitte wenden Sie sich an den Administrator!",
