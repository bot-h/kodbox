...
return array(
 ...
 khoảng ip: Hai ips được chia cho một đường đứt nét; ip khớp trong khoảng này; <br/>",
    ...
    "admin.storage.saveCorsTips"     => "Nhóm không được định cấu hình bằng CORS hoặc cấu hình sai, vui lòng làm theo tài liệu [Sử dụng trợ giúp] để định cấu hình",
    ...
    "admin.backup.position"          => "Vị trí dự phòng",
    ...
    "admin.backup.timeNote"          => "Lưu ý: Chỉ giữ lại dữ liệu sao lưu trong 7 ngày qua và ngày đầu tiên mỗi tháng. <br> Thời gian sao lưu:",
    "admin.backup.optionTime"        => "Sao lưu mất nhiều thời gian, vui lòng cố gắng chọn khoảng thời gian ngoài công việc",
    "admin.backup.optionLocation"    => "Vui lòng tạo một bộ lưu trữ dành riêng để sao lưu",
    "admin.backup.optionTips1"       => "Sao lưu dữ liệu được chia thành hai phần: sao lưu tệp và sao lưu cơ sở dữ liệu.",
    "admin.backup.optionTips2"       => "Trước tiên, bạn cần chỉ định một bộ lưu trữ có đủ dung lượng dành cho lưu trữ sao lưu dữ liệu.",
    "admin.backup.optionTips3"       => "Sau khi tác vụ được bắt đầu, các tệp được sao lưu dần dần vào bộ lưu trữ đích và cơ sở dữ liệu nhận được tất cả dữ liệu, tạo tệp SQL và sao lưu chúng vào thư mục cơ sở dữ liệu của bộ lưu trữ đích theo ngày.",
    "admin.backup.optionTips4"       => "Dữ liệu sao lưu chỉ giữ 7 ngày cuối cùng và ngày đầu tiên mỗi tháng.",
 ...
 post_max_size, cần khởi động lại)",
    ...
    "log-event-move-more"            => "[1] tài liệu được di chuyển",
    "log-event-move-more-desc"       => "[1] Chuyển từ [2] sang [3]",
    "log-event-moveOut-more-desc"    => "[1] đã bị xóa khỏi [2] [3]",
