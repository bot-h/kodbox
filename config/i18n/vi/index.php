...
return array(
    ...
    "admin.setting.loginIpCheckDesc" => "Sau khi mở, chỉ người dùng có ip được chỉ định mới có thể đăng nhập, hãy cẩn thận",
    "admin.setting.loginIpAllow"     => "IP được phép",
    "admin.setting.loginIpAllowDesc" => "<b>Điền vào các quy tắc như sau (IP cục bộ và IP LAN của máy chủ được cho phép theo mặc định):</b><br/>
 Ip dòng đơn: khớp nếu bằng nhau, ví dụ: 55.55.55.55<br/>
 Tiền tố ip dòng đơn: ip bắt đầu bằng tiền tố và khớp; ví dụ: 55,55<br/>
 phần ip: Hai ips được chia bằng một dấu gạch ngang và ips khớp trong phần này; ví dụ: 55.55.0.0-55.55.1.255<br/>",
    ...
    "ERROR_IP_NOT_ALLOW"             => "IP hiện tại của bạn không nằm trong danh sách trắng các IP được phép đăng nhập, vui lòng liên hệ với quản trị viên!",
