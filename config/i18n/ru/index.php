...
return array(
 ...
 интервал ip: два ips разделены пунктирной линией, ip соответствует этому интервалу; <br/>",
    ...
    "admin.storage.saveCorsTips"     => "Bucket не сконфигурирован с CORS, или конфигурация неверна, пожалуйста, следуйте документу [Использовать помощь] для настройки",
    ...
    "admin.backup.position"          => "Местоположение резервной копии",
    ...
    "admin.backup.timeNote"          => "Примечание. Сохраняются только резервные данные за последние 7 дней и 1 числа каждого месяца. <br> Время резервного копирования:",
    "admin.backup.optionTime"        => "Резервное копирование занимает много времени, пожалуйста, попробуйте выбрать период времени вне работы",
    "admin.backup.optionLocation"    => "Пожалуйста, создайте хранилище, предназначенное для резервного копирования",
    "admin.backup.optionTips1"       => "Резервное копирование данных делится на две части: резервное копирование файлов и резервное копирование базы данных.",
    "admin.backup.optionTips2"       => "Во-первых, вам нужно указать хранилище с достаточным пространством, зарезервированным для хранилища резервных копий данных.",
    "admin.backup.optionTips3"       => "После запуска задачи файлы постепенно архивируются в целевое хранилище, и база данных получает все данные, генерирует файлы SQL и резервирует их в каталог базы данных целевого хранилища по дате.",
    "admin.backup.optionTips4"       => "Данные резервного копирования хранятся только за последние 7 дней и 1-е число каждого месяца.",
 ...
 post_max_size, нужно перезагрузить)",
    ...
    "log-event-move-more"            => "[1] документы перемещены",
    "log-event-move-more-desc"       => "[1] Перейти от [2] к [3]",
    "log-event-moveOut-more-desc"    => "[1] удалено из [2] [3]",
