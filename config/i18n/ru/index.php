...
return array(
    ...
    "admin.setting.loginIpCheckDesc" => "После открытия войти могут только пользователи с указанным ip, будьте осторожны",
    "admin.setting.loginIpAllow"     => "Разрешенный IP",
    "admin.setting.loginIpAllowDesc" => "<b>Заполните правила следующим образом (локальный IP-адрес сервера и IP-адрес LAN разрешены по умолчанию):</b><br/>
 Однострочный IP-адрес: совпадение, если оно равно, например: 55.55.55.55<br/>
 Однострочный префикс ip: ip начинается с префикса и совпадает; например: 55,55<br/>
 Раздел ip: два IP-адреса разделены тире, и IP-адреса совпадают в этом разделе; например: 55.55.0.0-55.55.1.255<br/>",
    ...
    "ERROR_IP_NOT_ALLOW"             => "Ваш текущий IP-адрес отсутствует в белом списке IP-адресов, разрешенных для входа, обратитесь к администратору!",
