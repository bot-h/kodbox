...
return array(
 ...
 intervalo ip: os dois ips são divididos por uma linha tracejada; o ip corresponde nesse intervalo; <br/>",
    ...
    "admin.storage.saveCorsTips"     => "A caçamba não está configurada com o CORS ou a configuração está incorreta. Siga o documento [Use Help] para configurar",
    ...
    "admin.backup.position"          => "Local de backup",
    ...
    "admin.backup.timeNote"          => "Nota: Apenas os dados de backup dos últimos 7 dias e do 1º de cada mês são mantidos. <br> Tempo de backup:",
    "admin.backup.optionTime"        => "O backup demora muito tempo, tente escolher um período fora do trabalho",
    "admin.backup.optionLocation"    => "Crie um armazenamento dedicado ao backup",
    "admin.backup.optionTips1"       => "O backup de dados é dividido em duas partes: backup de arquivo e backup do banco de dados.",
    "admin.backup.optionTips2"       => "Primeiro, você precisa especificar um armazenamento com espaço suficiente reservado para o armazenamento de backup de dados.",
    "admin.backup.optionTips3"       => "Após o início da tarefa, é feito backup incremental dos arquivos no armazenamento de destino, e o banco de dados obtém todos os dados, gera arquivos SQL e os faz backup no diretório de banco de dados do armazenamento de destino por data.",
    "admin.backup.optionTips4"       => "Os dados de backup mantêm apenas os últimos 7 dias e o 1º de cada mês.",
 ...
 post_max_size, precisa reiniciar)",
    ...
    "log-event-move-more-desc"       => "[1] Mova de [2] para [3]",
    "log-event-moveOut-more-desc"    => "[1] removido de [2] [3]",
