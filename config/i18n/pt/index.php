...
return array(
    ...
    "admin.setting.loginIpCheckDesc" => "Após a abertura, apenas usuários com o ip especificado podem fazer login, por favor, tome cuidado",
    "admin.setting.loginIpAllow"     => "IP permitido",
    "admin.setting.loginIpAllowDesc" => "<b>Preencha as regras da seguinte forma (o IP local do servidor e o IP da LAN são permitidos por padrão):</b><br/>
 IP de linha única: corresponder se for igual, por exemplo: 55.55.55.55<br/>
 Prefixo ip de linha única: ip começa com prefixo e corresponde; por exemplo: 55,55<br/>
 seção ip: dois ips são divididos por um travessão e os ips correspondem nesta seção; por exemplo: 55.55.0.0-55.55.1.255<br/>",
    ...
    "ERROR_IP_NOT_ALLOW"             => "Seu IP atual não está na lista de permissões de IPs com permissão para fazer login, entre em contato com o administrador!",
