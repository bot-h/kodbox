...
return array(
    ...
    "admin.setting.loginIpCheckDesc" => "หลังจากเปิดใช้งานเฉพาะผู้ใช้ที่มี IP ที่ระบุเท่านั้นที่สามารถเข้าสู่ระบบได้โปรดระวัง",
    "admin.setting.loginIpAllow"     => "IP ที่ได้รับอนุญาต",
    "admin.setting.loginIpAllowDesc" => "<b>กรอกกฎดังต่อไปนี้ (อนุญาตให้ใช้ IP ภายในและ LAN IP ของเซิร์ฟเวอร์โดยค่าเริ่มต้น):</b><br/>
 IP บรรทัดเดียว: จับคู่ถ้าเท่ากันตัวอย่างเช่น 55.55.55.55<br/>
 คำนำหน้า IP บรรทัดเดียว: ip ขึ้นต้นด้วยคำนำหน้าและตรงกันตัวอย่างเช่น 55.55<br/>
 ส่วน ip: สอง ips ถูกหารด้วยเส้นประและ ips ตรงกับภายในส่วนนี้เช่น 55.55.0.0-55.55.1.255<br/>",
    ...
    "ERROR_IP_NOT_ALLOW"             => "IP ปัจจุบันของคุณไม่อยู่ในรายการที่อนุญาตพิเศษของ IP ที่อนุญาตให้เข้าสู่ระบบโปรดติดต่อผู้ดูแลระบบ!",
