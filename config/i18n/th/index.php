...
return array(
 ...
 ip interval: สอง ips ถูกหารด้วยเส้นประการจับคู่ ip ในช่วงเวลานี้ <br/>",
    ...
    "admin.storage.saveCorsTips"     => "ที่ฝากข้อมูลไม่ได้รับการกำหนดค่าด้วย CORS หรือการกำหนดค่าผิดโปรดทำตามเอกสาร [ใช้วิธีใช้] เพื่อกำหนดค่า",
    ...
    "admin.backup.position"          => "ตำแหน่งสำรอง",
    ...
    "admin.backup.timeNote"          => "หมายเหตุ: ข้อมูลสำรองสำหรับ 7 วันล่าสุดและวันที่ 1 ของแต่ละเดือนจะถูกเก็บไว้ <br> เวลาสำรอง:",
    "admin.backup.optionTime"        => "การสำรองข้อมูลใช้เวลานานโปรดลองเลือกช่วงเวลานอกเวลาทำงาน",
    "admin.backup.optionLocation"    => "โปรดสร้างที่เก็บข้อมูลสำหรับการสำรองข้อมูลโดยเฉพาะ",
    "admin.backup.optionTips1"       => "การสำรองข้อมูลแบ่งออกเป็นสองส่วนคือการสำรองไฟล์และการสำรองฐานข้อมูล",
    "admin.backup.optionTips2"       => "ก่อนอื่นคุณต้องระบุที่เก็บข้อมูลที่มีพื้นที่เพียงพอสำหรับการสำรองข้อมูล",
    "admin.backup.optionTips3"       => "หลังจากเริ่มงานแล้วไฟล์จะถูกสำรองเพิ่มไปยังที่เก็บข้อมูลเป้าหมายและฐานข้อมูลจะได้รับข้อมูลทั้งหมดสร้างไฟล์ SQL และสำรองข้อมูลไปยังไดเรกทอรีฐานข้อมูลของที่เก็บข้อมูลเป้าหมายตามวันที่",
    "admin.backup.optionTips4"       => "ข้อมูลสำรองจะเก็บไว้ใน 7 วันล่าสุดและวันที่ 1 ของแต่ละเดือนเท่านั้น",
 ...
 post_max_size ต้องเริ่มต้นใหม่)",
    ...
    "log-event-move-more-desc"       => "[1] ย้ายจาก [2] ถึง [3]",
    "log-event-moveOut-more-desc"    => "[1] นำออกจาก [2] [3]",
