...
return array(
 ...
 intervalo de ip: los dos ips se dividen por una línea discontinua; las coincidencias de ip en este intervalo; <br/>",
    ...
    "admin.storage.saveCorsTips"     => "Bucket no está configurado con CORS, o la configuración es incorrecta, siga el documento [Usar ayuda] para configurar",
    ...
    "admin.backup.position"          => "Ubicación de respaldo",
    ...
    "admin.backup.timeNote"          => "Nota: Solo se conservan los datos de la copia de seguridad de los últimos 7 días y el 1 de cada mes. <br> Tiempo de respaldo:",
    "admin.backup.optionTime"        => "La copia de seguridad lleva mucho tiempo, intente elegir un período de tiempo fuera del trabajo",
    "admin.backup.optionLocation"    => "Cree un almacenamiento dedicado a la copia de seguridad.",
    "admin.backup.optionTips1"       => "La copia de seguridad de datos se divide en dos partes: copia de seguridad de archivos y copia de seguridad de la base de datos.",
    "admin.backup.optionTips2"       => "Primero, debe especificar un almacenamiento con suficiente espacio reservado para el almacenamiento de copia de seguridad de datos.",
    "admin.backup.optionTips3"       => "Una vez que se inicia la tarea, se realiza una copia de seguridad incremental de los archivos en el almacenamiento de destino, y la base de datos obtiene todos los datos, genera archivos SQL y los respalda en el directorio de la base de datos del almacenamiento de destino por fecha.",
    "admin.backup.optionTips4"       => "Los datos de la copia de seguridad solo guardan los últimos 7 días y el 1 de cada mes.",
 ...
 post_max_size, necesita reiniciar)",
    ...
    "log-event-move-more-desc"       => "[1] Mover de [2] a [3]",
    "log-event-moveOut-more-desc"    => "[1] eliminado de [2] [3]",
