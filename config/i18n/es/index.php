...
return array(
    ...
    "admin.setting.loginIpCheckDesc" => "Después de abrir, solo los usuarios con la IP especificada pueden iniciar sesión, tenga cuidado",
    "admin.setting.loginIpAllow"     => "IP permitida",
    "admin.setting.loginIpAllowDesc" => "<b>Complete las reglas de la siguiente manera (la IP local del servidor y la IP de LAN están permitidas por defecto):</b><br/>
 IP de línea única: coincidir si es igual, por ejemplo: 55.55.55.55<br/>
 Prefijo de ip de una línea: ip comienza con el prefijo y coincide; por ejemplo: 55.55<br/>
 sección ip: dos ips están divididas por un guión y las ips coinciden dentro de esta sección; por ejemplo: 55.55.0.0-55.55.1.255<br/>",
    ...
    "ERROR_IP_NOT_ALLOW"             => "Su IP actual no está en la lista blanca de IP permitidas para iniciar sesión, ¡comuníquese con el administrador!",
