...
return array(
 ...
 आईपी अंतराल: दो ips एक धराशायी रेखा से विभाजित होते हैं, इस अंतराल में आईपी मैच; <br/>",
    ...
    "admin.storage.saveCorsTips"     => "बाल्टी को CORS के साथ कॉन्फ़िगर नहीं किया गया है, या कॉन्फ़िगरेशन गलत है, कृपया कॉन्फ़िगर करने के लिए [सहायता का उपयोग करें] दस्तावेज़ का पालन करें",
    ...
    "admin.backup.position"          => "बैकअप स्थान",
    ...
    "admin.backup.timeNote"          => "नोट: पिछले 7 दिनों के लिए केवल बैकअप डेटा और प्रत्येक महीने के 1 को बरकरार रखा गया है। <br> बैकअप समय:",
    "admin.backup.optionTime"        => "बैकअप में लंबा समय लगता है, कृपया कार्य के बाहर एक समयावधि चुनने का प्रयास करें",
    "admin.backup.optionLocation"    => "कृपया बैकअप के लिए एक स्टोरेज बनाएं",
    "admin.backup.optionTips1"       => "डेटा बैकअप को दो भागों में विभाजित किया गया है: फ़ाइल बैकअप और डेटाबेस बैकअप।",
    "admin.backup.optionTips2"       => "सबसे पहले, आपको डेटा बैकअप भंडारण के लिए आरक्षित पर्याप्त स्थान के साथ एक भंडारण निर्दिष्ट करने की आवश्यकता है।",
    "admin.backup.optionTips3"       => "कार्य शुरू होने के बाद, फ़ाइलों को लक्ष्य स्टोरेज के लिए बड़े पैमाने पर बैकअप दिया जाता है, और डेटाबेस को सभी डेटा मिलते हैं, एसक्यूएल फाइलें उत्पन्न करता है, और उन्हें तारीख तक लक्ष्य भंडारण के डेटाबेस निर्देशिका में वापस कर देता है।",
    "admin.backup.optionTips4"       => "बैकअप डेटा केवल पिछले 7 दिनों और प्रत्येक महीने के 1 को रखता है।",
 ...
 post_max_size, पुनरारंभ करने की आवश्यकता है)",
    ...
    "log-event-move-more-desc"       => "[1] [2] से [3] तक ले जाएँ",
    "log-event-moveOut-more-desc"    => "[1] [2] से हटा दिया गया [3]",
