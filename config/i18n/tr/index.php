...
return array(
 ...
 ip aralığı: İki ips kesikli bir çizgiye bölünür; ip bu aralıkta eşleşir; <br/>",
    ...
    "admin.storage.saveCorsTips"     => "Grup CORS ile yapılandırılmamış veya yapılandırma yanlış, yapılandırmak için lütfen [Yardım Kullan] belgesini izleyin",
    ...
    "admin.backup.position"          => "Yedekleme yeri",
    ...
    "admin.backup.timeNote"          => "Not: Yalnızca son 7 gün ve her ayın 1'ine ait yedekleme verileri korunur. <br> Yedekleme zamanı:",
    "admin.backup.optionTime"        => "Yedekleme uzun zaman alıyor, lütfen iş dışında bir zaman aralığı seçmeyi deneyin",
    "admin.backup.optionLocation"    => "Lütfen yedeklemeye adanmış bir depolama alanı oluşturun",
    "admin.backup.optionTips1"       => "Veri yedekleme iki bölüme ayrılmıştır: dosya yedekleme ve veritabanı yedekleme.",
    "admin.backup.optionTips2"       => "İlk olarak, veri yedekleme depolaması için yeterli alana sahip bir depolama alanı belirtmeniz gerekir.",
    "admin.backup.optionTips3"       => "Görev başlatıldıktan sonra, dosyalar aşamalı olarak hedef depolamaya yedeklenir ve veritabanı tüm verileri alır, SQL dosyaları oluşturur ve bunları tarihe göre hedef depolamanın veritabanı dizinine yedekler.",
    "admin.backup.optionTips4"       => "Yedekleme verileri yalnızca son 7 günü ve her ayın 1'ini tutar.",
 ...
 post_max_size, yeniden başlatmanız gerekiyor)",
    ...
    "log-event-move-more"            => "[1] doküman taşındı",
    "log-event-move-more-desc"       => "[1] [2] &#39;den [3]&#39; e geçin",
    "log-event-moveOut-more-desc"    => "[1] [2] [3] &#39;ten kaldırıldı",
