...
return array(
    ...
    "admin.setting.loginIpCheckDesc" => "Açıldıktan sonra sadece belirtilen ip'e sahip kullanıcılar giriş yapabilir, lütfen dikkatli olun",
    "admin.setting.loginIpAllow"     => "İzin verilen IP",
    "admin.setting.loginIpAllowDesc" => "<b>Kuralları aşağıdaki gibi doldurun (sunucunun yerel IP ve LAN IP'sine varsayılan olarak izin verilir):</b><br/>
 Tek satır ip: eşitse eşleşir, örneğin: 55.55.55.55<br/>
 Tek satırlık ip öneki: ip, önek ile başlar ve eşleşir; örneğin: 55.55<br/>
 ip bölümü: İki ips bir tire ile bölünür ve ips bu bölümde eşleşir; örneğin: 55.55.0.0-55.55.1.255<br/>",
    ...
    "ERROR_IP_NOT_ALLOW"             => "Mevcut IP adresiniz, oturum açmasına izin verilen IP'lerin beyaz listesinde değil, lütfen yönetici ile iletişime geçin!",
