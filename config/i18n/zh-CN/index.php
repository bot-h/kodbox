...
return array(
    ...
    "admin.setting.loginIpCheckDesc" => "开启后,只允许指定ip的用户才能登录,请谨慎操作",
    "admin.setting.loginIpAllow"     => "允许的IP",
    "admin.setting.loginIpAllowDesc" => "<b>填写规则如下(默认允许服务器本机ip,以及局域网ip):</b><br/>
单行为ip: 相等则匹配, 例如:55.55.55.55<br/>
单行为ip前缀: ip以前缀为开头则匹配;例如:55.55<br/>
ip区段: 两个ip以中划线进行分割,ip在该区间内则匹配;例如:55.55.0.0-55.55.1.255<br/>",
    ...
    "ERROR_IP_NOT_ALLOW"             => "您当前ip不在允许登录的ip白名单里,请联系管理员!",
