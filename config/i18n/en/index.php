...
return array(
    ...
    "admin.setting.passwordErrorLockDesc" => "If the password is incorrect for 5 consecutive times, the account is locked for 30s and login is not allowed. After opening, it can effectively prevent the password from brute force cracking;",
    ...
    "admin.setting.loginIpCheckDesc" => "After opening, only users with the specified ip can log in, please be careful",
    "admin.setting.loginIpAllow"     => "Allowed IP",
    "admin.setting.loginIpAllowDesc" => "<b>Fill in the rules as follows (the server's local IP and LAN IP are allowed by default):</b><br/>
 Single line ip: match if equal, for example: 55.55.55.55<br/>
 Single line ip prefix: ip starts with the prefix and matches; for example: 55.55<br/>
 ip section: Two ips are divided by a dash, and ips match within this section; for example: 55.55.0.0-55.55.1.255<br/>",
    ...
    "ERROR_IP_NOT_ALLOW"             => "Your current IP is not in the whitelist of IPs allowed to log in, please contact the administrator!",
    ...
    "admin.share.reportTab"          => "Sharing report management",
