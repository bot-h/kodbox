...
return array(
    ...
    "admin.menu.server"              => "Server management",
 ...
 ip interval: The two ips are divided by a dashed line; ip matches in this interval; <br/>",
    ...
    "admin.storage.saveCorsTips"     => "Bucket is not configured with CORS, or the configuration is wrong, please follow the [Use Help] document to configure",
    ...
    "admin.backup.position"          => "Backup location",
    ...
    "admin.backup.timeNote"          => "Note: Only the backup data for the last 7 days and the 1st of each month are retained. <br> Backup time:",
    "admin.backup.optionTime"        => "Backup takes a long time, please try to choose a time period outside of work",
    "admin.backup.optionLocation"    => "Please create a storage dedicated to backup",
    "admin.backup.optionTips1"       => "Data backup is divided into two parts: file backup and database backup.",
    "admin.backup.optionTips2"       => "First, you need to specify a storage with enough space reserved for data backup storage.",
    "admin.backup.optionTips3"       => "After the task is started, the files are incrementally backed up to the target storage, and the database gets all the data, generates SQL files, and backs them up to the database directory of the target storage by date.",
    "admin.backup.optionTips4"       => "The backup data only keeps the last 7 days and the 1st of each month.",
 ...
 post_max_size, need to restart)",
    ...
    "log-event-move-more-desc"       => "[1] Move from [2] to [3]",
    "log-event-moveOut-more-desc"    => "[1] removed from [2] [3]",
