...
return array(
 ...
 post_max_size, need to restart)",
    ...
    "explorer.toolbar.rootPath"      => "Personal space",
    ...
    "user.displayHideFileDesc"       => "Hidden files: files starting with., And hidden file names set in the background of the system; hidden files will be displayed after opening;",
