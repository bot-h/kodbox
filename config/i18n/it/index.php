...
return array(
    ...
    "admin.setting.loginIpCheckDesc" => "Dopo l'apertura, solo gli utenti con l'ip specificato possono accedere, fai attenzione",
    "admin.setting.loginIpAllow"     => "IP consentito",
    "admin.setting.loginIpAllowDesc" => "<b>Completare le regole come segue (l'IP locale del server e l'IP LAN sono consentiti per impostazione predefinita):</b><br/>
 IP a riga singola: corrisponde se uguale, ad esempio: 55.55.55.55<br/>
 Prefisso ip a riga singola: ip inizia con il prefisso e corrisponde; ad esempio: 55.55<br/>
 Sezione ip: due ips sono divisi da un trattino e ips corrispondono all&#39;interno di questa sezione; ad esempio: 55.55.0.0-55.55.1.255<br/>",
    ...
    "ERROR_IP_NOT_ALLOW"             => "Il tuo IP attuale non è nella whitelist degli IP autorizzati ad accedere, contatta l'amministratore!",
