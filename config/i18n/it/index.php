...
return array(
 ...
 intervallo ip: i due ips sono divisi da una linea tratteggiata; ip corrisponde in questo intervallo; <br/>",
    ...
    "admin.storage.saveCorsTips"     => "Bucket non è configurato con CORS o la configurazione è errata, seguire il documento [Usa guida] per configurare",
    ...
    "admin.backup.position"          => "Posizione di backup",
    ...
    "admin.backup.timeNote"          => "Nota: vengono conservati solo i dati di backup degli ultimi 7 giorni e il 1 di ogni mese. <br> Tempo di backup:",
    "admin.backup.optionTime"        => "Il backup richiede molto tempo, prova a scegliere un periodo di tempo al di fuori del lavoro",
    "admin.backup.optionLocation"    => "Si prega di creare uno spazio di archiviazione dedicato al backup",
    "admin.backup.optionTips1"       => "Il backup dei dati è diviso in due parti: backup dei file e backup del database.",
    "admin.backup.optionTips2"       => "Innanzitutto, è necessario specificare un archivio con spazio sufficiente riservato per l'archiviazione del backup dei dati.",
    "admin.backup.optionTips3"       => "Dopo l'avvio dell'attività, viene eseguito il backup incrementale dei file nella memoria di destinazione e il database ottiene tutti i dati, genera file SQL e li esegue il backup nella directory del database della memoria di destinazione per data.",
    "admin.backup.optionTips4"       => "I dati di backup conservano solo gli ultimi 7 giorni e il 1 di ogni mese.",
 ...
 post_max_size, è necessario riavviare)",
    ...
    "log-event-move-more-desc"       => "[1] Passa da [2] a [3]",
    "log-event-moveOut-more-desc"    => "[1] rimosso da [2] [3]",
