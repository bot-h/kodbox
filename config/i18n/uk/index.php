...
return array(
    ...
    "admin.setting.loginIpCheckDesc" => "Після відкриття лише користувачі із зазначеним ip можуть увійти, будьте обережні",
    "admin.setting.loginIpAllow"     => "Дозволений IP",
    "admin.setting.loginIpAllowDesc" => "<b>Заповніть правила наступним чином (локальні IP-адреси сервера та IP локальної мережі дозволені за замовчуванням):</b><br/>
 Однорядковий ip: збіг, якщо рівний, наприклад: 55.55.55.55<br/>
 Однорядковий префікс ip: ip починається з префікса та збігається; наприклад: 55.55<br/>
 ip section: Два ips розділені тире, і ips збігаються в цьому розділі; наприклад: 55.55.0.0-55.55.1.255<br/>",
    ...
    "ERROR_IP_NOT_ALLOW"             => "Вашої поточної IP-адреси немає в білому списку IP-адрес, на які дозволено входити, зверніться до адміністратора!",
