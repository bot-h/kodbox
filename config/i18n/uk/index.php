...
return array(
 ...
 інтервал ip: два ips розділені пунктирною лінією; ip збігається в цьому інтервалі; <br/>",
    ...
    "admin.storage.saveCorsTips"     => "Bucket не налаштовано CORS, або конфігурація неправильна, будь ласка, дотримуйтесь документа [Use Help] для налаштування",
    ...
    "admin.backup.position"          => "Резервне розташування",
    ...
    "admin.backup.timeNote"          => "Примітка. Зберігаються лише дані резервного копіювання за останні 7 днів та 1-го числа кожного місяця. <br> Час резервного копіювання:",
    "admin.backup.optionTime"        => "Резервне копіювання займає багато часу. Будь ласка, спробуйте вибрати період часу поза роботою",
    "admin.backup.optionLocation"    => "Створіть сховище, призначене для резервного копіювання",
    "admin.backup.optionTips1"       => "Резервне копіювання даних поділяється на дві частини: резервне копіювання файлів та резервне копіювання бази даних.",
    "admin.backup.optionTips2"       => "По-перше, потрібно вказати сховище з достатньою кількістю місця, відведеного для резервного копіювання даних.",
    "admin.backup.optionTips3"       => "Після запуску завдання файли поступово створюються резервними копіями до цільового сховища, і база даних отримує всі дані, генерує файли SQL та створює резервні копії до каталогу баз даних цільового сховища за датою.",
    "admin.backup.optionTips4"       => "Дані резервного копіювання зберігаються лише за останні 7 днів та 1 числа кожного місяця.",
 ...
 post_max_size, потрібно перезапустити)",
    ...
    "log-event-move-more-desc"       => "[1] Перехід від [2] до [3]",
    "log-event-moveOut-more-desc"    => "[1] видалено з [2] [3]",
