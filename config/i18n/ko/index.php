...
return array(
    ...
    "admin.setting.loginIpCheckDesc" => "개봉 후 지정된 IP를 가진 사용자 만 로그인이 가능하므로주의하세요.",
    "admin.setting.loginIpAllow"     => "허용 된 IP",
    "admin.setting.loginIpAllowDesc" => "<b>다음과 같이 규칙을 입력하십시오 (서버의 로컬 IP 및 LAN IP는 기본적으로 허용됨).</b><br/>
 단일 행 ip : 같으면 일치 (예 : 55.55.55.55)<br/>
 한 줄 ip 접두사 : ip는 접두사로 시작하여 일치합니다 (예 : 55.55).<br/>
 ip 섹션 : 두 개의 ip가 대시로 나뉘고 ip는이 섹션 내에서 일치합니다 (예 : 55.55.0.0-55.55.1.255).<br/>",
    ...
    "ERROR_IP_NOT_ALLOW"             => "귀하의 현재 IP는 로그인이 허용 된 IP의 화이트리스트에 없습니다. 관리자에게 문의하십시오!",
