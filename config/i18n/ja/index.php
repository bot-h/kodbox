...
return array(
    ...
    "admin.setting.loginIpCheckDesc" => "開封後は、指定したIPのユーザーのみログインできますのでご注意ください",
    "admin.setting.loginIpAllow"     => "許可されたIP",
    "admin.setting.loginIpAllowDesc" => "<b>次のようにルールを入力します（サーバーのローカルIPとLAN IPはデフォルトで許可されています）。</b><br/>
単一行ip：等しい場合に一致します。例：55.55.55.55<br/>
単一行のipプレフィックス：ipはプレフィックスで始まり、一致します。例：55.55<br/>
 ipセクション：2つのipはダッシュで分割され、ipはこのセクション内で一致します。例：55.55.0.0-55.55.1.255<br/>",
    ...
    "ERROR_IP_NOT_ALLOW"             => "現在のIPは、ログインを許可されているIPのホワイトリストに含まれていません。管理者に連絡してください。",
