...
return array(
    ...
    "admin.setting.loginIpCheckDesc" => "Po otwarciu tylko użytkownicy z podanym adresem IP mogą się zalogować, należy zachować ostrożność",
    "admin.setting.loginIpAllow"     => "Dozwolone IP",
    "admin.setting.loginIpAllowDesc" => "<b>Wypełnij reguły w następujący sposób (lokalny adres IP serwera i adres IP sieci LAN są domyślnie dozwolone):</b><br/>
 Pojedynczy adres IP: dopasuj, jeśli jest równy, na przykład: 55.55.55.55<br/>
 Pojedynczy prefiks ip: ip zaczyna się od prefiksu i pasuje, na przykład: 55.55<br/>
 sekcja ip: dwa ips są podzielone myślnikiem, a adresy IP są zgodne w tej sekcji; na przykład: 55.55.0.0-55.55.1.255<br/>",
    ...
    "ERROR_IP_NOT_ALLOW"             => "Twój aktualny adres IP nie znajduje się na białej liście adresów IP, na które można się zalogować, skontaktuj się z administratorem!",
