...
return array(
 ...
 Interwał ip: dwa IP są podzielone linią przerywaną; ip odpowiada w tym interwale; <br/>",
    ...
    "admin.storage.serverDesc"       => "ftp / s: // ip, domyślnie jest to ftp bez protokołu",
    ...
    "admin.storage.saveCorsTips"     => "Zasobnik nie jest skonfigurowany z CORS lub konfiguracja jest nieprawidłowa, postępuj zgodnie z dokumentem [Użyj pomocy], aby skonfigurować",
    ...
    "admin.backup.position"          => "Lokalizacja kopii zapasowej",
    ...
    "admin.backup.timeNote"          => "Uwaga: zachowywane są tylko kopie zapasowe z ostatnich 7 dni i pierwszego dnia każdego miesiąca. <br> Czas podtrzymania:",
    "admin.backup.optionTime"        => "Tworzenie kopii zapasowych zajmuje dużo czasu, spróbuj wybrać okres poza pracą",
    "admin.backup.optionLocation"    => "Utwórz miejsce przeznaczone na kopie zapasowe",
    "admin.backup.optionTips1"       => "Kopia zapasowa danych jest podzielona na dwie części: kopię zapasową plików i kopię zapasową bazy danych.",
    "admin.backup.optionTips2"       => "Najpierw musisz określić magazyn z wystarczającą ilością miejsca zarezerwowanego do przechowywania kopii zapasowych danych.",
    "admin.backup.optionTips3"       => "Po uruchomieniu zadania kopie zapasowe plików są tworzone przyrostowo w docelowej pamięci masowej, a baza danych pobiera wszystkie dane, generuje pliki SQL i tworzy ich kopię zapasową w katalogu bazy danych docelowej pamięci masowej według daty.",
    "admin.backup.optionTips4"       => "Dane kopii zapasowej przechowuje tylko ostatnie 7 dni i pierwszy dzień każdego miesiąca.",
 ...
 post_max_size, trzeba zrestartować)",
    ...
    "log-event-move-more"            => "[1] przeniesiono dokumenty",
    "log-event-move-more-desc"       => "[1] Przejdź z [2] do [3]",
    "log-event-moveOut-more-desc"    => "[1] usunięto z [2] [3]",
