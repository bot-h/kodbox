...
return array(
 ...
 intervalle ip: les deux ips sont divisés par une ligne pointillée; ip correspond à cet intervalle; <br/>",
    ...
    "admin.storage.saveCorsTips"     => "Bucket n'est pas configuré avec CORS, ou la configuration est incorrecte, veuillez suivre le document [Utiliser l'aide] pour configurer",
    ...
    "admin.backup.position"          => "Emplacement de sauvegarde",
    ...
    "admin.backup.timeNote"          => "Remarque: seules les données de sauvegarde des 7 derniers jours et du 1er de chaque mois sont conservées. <br> Temps de sauvegarde:",
    "admin.backup.optionTime"        => "La sauvegarde prend beaucoup de temps, veuillez essayer de choisir une période en dehors du travail",
    "admin.backup.optionLocation"    => "Veuillez créer un stockage dédié à la sauvegarde",
    "admin.backup.optionTips1"       => "La sauvegarde des données est divisée en deux parties: la sauvegarde des fichiers et la sauvegarde de la base de données.",
    "admin.backup.optionTips2"       => "Tout d'abord, vous devez spécifier un stockage avec suffisamment d'espace réservé pour le stockage de sauvegarde des données.",
    "admin.backup.optionTips3"       => "Une fois la tâche démarrée, les fichiers sont sauvegardés de manière incrémentielle sur le stockage cible, et la base de données obtient toutes les données, génère des fichiers SQL et les sauvegarde dans le répertoire de base de données du stockage cible par date.",
    "admin.backup.optionTips4"       => "Les données de sauvegarde ne conservent que les 7 derniers jours et le 1er de chaque mois.",
 ...
 post_max_size, besoin de redémarrer)",
    ...
    "log-event-move-more-desc"       => "[1] Passer de [2] à [3]",
    "log-event-moveOut-more-desc"    => "[1] supprimé de [2] [3]",
