...
return array(
    ...
    "admin.setting.loginIpAllowDesc" => "<b>Remplissez les règles comme suit (l'adresse IP locale du serveur et l'IP LAN sont autorisées par défaut):</b><br/>
 IP de ligne unique: correspond si égal, par exemple: 55.55.55.55<br/>
 Préfixe ip d&#39;une seule ligne: ip commence par le préfixe et correspond; par exemple: 55,55<br/>
 section ip: deux ips sont divisés par un tiret et les ips correspondent dans cette section; par exemple: 55.55.0.0-55.55.1.255<br/>",
    ...
    "ERROR_IP_NOT_ALLOW"             => "Votre adresse IP actuelle n'est pas dans la liste blanche des adresses IP autorisées à se connecter, veuillez contacter l'administrateur!",
