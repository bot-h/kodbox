...
return array(
    ...
    "admin.setting.loginIpCheckDesc" => "Setelah dibuka, hanya pengguna dengan ip tertentu yang dapat masuk, harap berhati-hati",
    "admin.setting.loginIpAllow"     => "IP yang diizinkan",
    "admin.setting.loginIpAllowDesc" => "<b>Isi aturan sebagai berikut (IP lokal server dan IP LAN diizinkan secara default):</b><br/>
 IP baris tunggal: cocok jika sama, misalnya: 55.55.55.55<br/>
 Awalan ip baris tunggal: ip dimulai dengan awalan dan kecocokan; misalnya: 55.55<br/>
 bagian ip: Dua ip dibagi dengan tanda hubung, dan ips cocok dengan bagian ini; misalnya: 55.55.0.0-55.55.1.255<br/>",
    ...
    "ERROR_IP_NOT_ALLOW"             => "IP Anda saat ini tidak ada dalam daftar putih ip yang diizinkan untuk masuk, silakan hubungi administrator!",
