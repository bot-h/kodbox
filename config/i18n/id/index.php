...
return array(
 ...
 ip interval: Dua ips dibagi dengan garis putus-putus; ip cocok dalam interval ini; <br/>",
    ...
    "admin.storage.serverDesc"       => "ftp / s: // ip, standarnya adalah ftp tanpa protokol",
    ...
    "admin.storage.saveCorsTips"     => "Bucket tidak dikonfigurasikan dengan CORS, atau konfigurasinya salah, harap ikuti dokumen [Pakai Bantuan] untuk mengonfigurasi",
    ...
    "admin.backup.position"          => "Lokasi cadangan",
    ...
    "admin.backup.timeNote"          => "Catatan: Hanya data cadangan selama 7 hari terakhir dan tanggal 1 setiap bulan yang disimpan. <br> Waktu cadangan:",
    "admin.backup.optionTime"        => "Pencadangan membutuhkan waktu lama, coba pilih periode waktu di luar pekerjaan",
    "admin.backup.optionLocation"    => "Harap buat penyimpanan yang didedikasikan untuk cadangan",
    "admin.backup.optionTips1"       => "Cadangan data dibagi menjadi dua bagian: cadangan file dan cadangan basis data.",
    "admin.backup.optionTips2"       => "Pertama, Anda perlu menentukan penyimpanan dengan ruang yang cukup dicadangkan untuk penyimpanan cadangan data.",
    "admin.backup.optionTips3"       => "Setelah tugas dimulai, file secara bertahap didukung ke penyimpanan target, dan database mendapatkan semua data, menghasilkan file SQL, dan mem-backupnya ke direktori database penyimpanan target berdasarkan tanggal.",
    "admin.backup.optionTips4"       => "Data cadangan hanya menyimpan 7 hari terakhir dan tanggal 1 setiap bulan.",
 ...
 post_max_size, perlu memulai ulang)",
    ...
    "log-event-move-more-desc"       => "[1] Pindah dari [2] ke [3]",
    "log-event-moveOut-more-desc"    => "[1] dihapus dari [2] [3]",
