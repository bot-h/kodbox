...
return array(
 ...
 فاصل ip: ينقسم ips بين اثنين من خط متقطع ؛ يطابق ip في هذا الفاصل ؛ <br/>",
    ...
    "admin.storage.serverDesc"       => "ftp / s: // ip ، الافتراضي هو بروتوكول ftp بدون بروتوكول",
    ...
    "admin.storage.saveCorsTips"     => "لم يتم تكوين الجرافة باستخدام CORS ، أو أن التكوين غير صحيح ، يرجى اتباع مستند [Use Help] للتهيئة",
    ...
    "admin.backup.position"          => "موقع النسخ الاحتياطي",
    ...
    "admin.backup.timeNote"          => "ملاحظة: يتم الاحتفاظ ببيانات النسخ الاحتياطي فقط للأيام السبعة الأخيرة والأولى من كل شهر. <br> وقت النسخ الاحتياطي:",
    "admin.backup.optionTime"        => "يستغرق النسخ الاحتياطي وقتًا طويلاً ، يرجى محاولة اختيار فترة زمنية خارج العمل",
    "admin.backup.optionLocation"    => "يرجى إنشاء مساحة تخزين مخصصة للنسخ الاحتياطي",
    "admin.backup.optionTips1"       => "ينقسم النسخ الاحتياطي للبيانات إلى قسمين: النسخ الاحتياطي للملف والنسخ الاحتياطي لقاعدة البيانات.",
    "admin.backup.optionTips2"       => "أولاً ، تحتاج إلى تحديد مساحة تخزين بها مساحة كافية محفوظة لتخزين النسخ الاحتياطي للبيانات.",
    "admin.backup.optionTips3"       => "بعد بدء المهمة ، يتم نسخ الملفات احتياطيًا بشكل متزايد إلى التخزين الهدف ، وتحصل قاعدة البيانات على جميع البيانات ، وتولد ملفات SQL ، وتدعمها إلى دليل قاعدة البيانات للتخزين الهدف حسب التاريخ.",
    "admin.backup.optionTips4"       => "تحتفظ بيانات النسخ الاحتياطي فقط بآخر 7 أيام والأولى من كل شهر.",
 ...
 post_max_size ، تحتاج إلى إعادة التشغيل)",
    ...
    "log-event-move-more"            => "تم نقل [1] مستندات",
    "log-event-move-more-desc"       => "[1] الانتقال من [2] إلى [3]",
    "log-event-moveOut-more-desc"    => "[1] تمت إزالته من [2] [3]",
