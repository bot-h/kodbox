...
return array(
    ...
    "admin.setting.loginIpCheckDesc" => "بعد تشغيله ، يمكن فقط للمستخدمين الذين لديهم عنوان IP المحدد تسجيل الدخول ، يرجى توخي الحذر",
    "admin.setting.loginIpAllow"     => "عنوان IP المسموح به",
    "admin.setting.loginIpAllowDesc" => "<b>املأ القواعد على النحو التالي (يُسمح بشكل افتراضي لعناوين IP المحلية و LAN IP الخاصة بالخادم):</b><br/>
 سطر واحد ip: تطابق إذا كانت متساوية ، على سبيل المثال: 55.55.55.55<br/>
 بادئة ip ذات سطر واحد: يبدأ ip بالبادئة والمطابقة ؛ على سبيل المثال: 55.55<br/>
 قسم ip: قسمان ips مقسومان على شرطة ، ومطابقة ips داخل هذا القسم ؛ على سبيل المثال: 55.55.0.0-55.55.1.255<br/>",
    ...
    "ERROR_IP_NOT_ALLOW"             => "عنوان IP الحالي الخاص بك غير موجود في القائمة البيضاء لعناوين IP المسموح لها بتسجيل الدخول ، يرجى الاتصال بالمسؤول!",
